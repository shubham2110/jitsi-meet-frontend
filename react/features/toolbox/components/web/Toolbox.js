...
class Toolbox extends Component < Props, State > {
    ...
    constructor(props: Props) {
        ...
        this._onShortcutToggleFullScreen = this._onShortcutToggleFullScreen
            .bind(this);
        this._onShortcutToggleRaiseHand = this._onShortcutToggleRaiseHand
            .bind(this);
        this._onShortcutToggleScreenshare = this
            ._onShortcutToggleScreenshare.bind(this);
        this._onShortcutToggleVideoQuality = this
            ._onShortcutToggleVideoQuality.bind(this);
        this._onToolbarOpenFeedback = this._onToolbarOpenFeedback.bind(
            this);
        this._onToolbarOpenInvite = this._onToolbarOpenInvite.bind(this);
        this._onToolbarOpenKeyboardShortcuts = this
            ._onToolbarOpenKeyboardShortcuts.bind(this);
        this._onToolbarOpenSpeakerStats = this._onToolbarOpenSpeakerStats
            .bind(this);
        this._onToolbarOpenEmbedMeeting = this._onToolbarOpenEmbedMeeting
            .bind(this);
        ...
        this._onToolbarToggleFullScreen = this._onToolbarToggleFullScreen
            .bind(this);
        this._onToolbarToggleProfile = this._onToolbarToggleProfile.bind(
            this);
        this._onToolbarToggleRaiseHand = this._onToolbarToggleRaiseHand
            .bind(this);
        this._onToolbarToggleScreenshare = this._onToolbarToggleScreenshare
            .bind(this);
        this._onToolbarToggleSharedVideo = this._onToolbarToggleSharedVideo
            .bind(this);
        this._onToolbarOpenLocalRecordingInfoDialog = this
            ._onToolbarOpenLocalRecordingInfoDialog.bind(this);
        this._onShortcutToggleTileView = this._onShortcutToggleTileView
            .bind(this);
    ...
    _isDesktopSharingButtonVisible() {
        ...
        return (_desktopSharingEnabled ||
                _desktopSharingDisabledTooltipKey) && _localParticipant.role == "moderator");
    }
    ...
    _renderDesktopSharingButton(isInOverflowMenu = false) {
        ...
        if (isInOverflowMenu) {
            return ( <
                OverflowMenuItem accessibilityLabel = {
        ...
        return ( <
            ToolbarButton accessibilityLabel = {
                t('toolbar.accessibilityLabel.shareYourScreen')
            }
            disabled = {
                !_desktopSharingEnabled
    ...
    _renderOverflowMenuContent() {
        ...
        return [
            ...
            icon = {
                _fullScreen ? IconExitFullScreen : IconFullScreen
            }
            key = 'fullscreen'
            onClick = {
            ...
            text = {
                _fullScreen ? t('toolbar.exitFullScreen') : t(
            ...
            text = {
                _sharingVideo ? t('toolbar.stopSharedVideo') : t(
                    'toolbar.sharedvideo')
            }
            />,
            ...
            OverflowMenuItem
            accessibilityLabel = {
                t('toolbar.accessibilityLabel.embedMeeting')
            }
            icon = {
                IconCodeBlock
            }
    ...
    _renderMovedButtons(movedButtons) {
        ...
        return movedButtons.map(buttonName => {
            switch (buttonName) {
                ...
                case 'security':
                    return ( <
                        SecurityDialogButton key = 'security'
                        showLabel = {
                            true
                        }
                        />
                ...
                case 'tileview':
                    return <TileViewButton showLabel = {
                        true
                    }
                    />;
                case 'localrecording':
    ...
    _renderToolboxContent() {
        ...
        const overflowHasItems = Boolean(overflowMenuContent.filter(child =>
            child).length);
        const toolbarAccLabel =
        ...
        const showOverflowMenu = this.state.windowWidth >=
            verySmallThreshold || isMobileBrowser();
        ...
        if (this._shouldShowButton('security') || this._shouldShowButton(
                'info')) {
        ...
        div className = 'button-group-right' > {
                buttonsRight.indexOf('localrecording') !== -
                1 &&
                <
                LocalRecordingButton
                onClick = {
                ...
                /> } {
                buttonsRight.indexOf('security') !== -
                    1 &&
                    <
                    SecurityDialogButton customClass =
                    'security-toolbar-button' / >
            } {
                buttonsRight.indexOf('overflowmenu') !==
                    -1 &&
                    <
                    OverflowMenuButton
                isOpen = {
...
_shouldShowButton(buttonName) {
    return this.props._visibleButtons
        .has(buttonName);
}
}
...
function _mapStateToProps(state) {
    ...
    const sharedVideoStatus = state[
        'features/shared-video'].status;
    const {
        fullScreen,
        overflowMenuVisible
    ...
    const localParticipant = getLocalParticipant(
        state);
    const localRecordingStates = state[
        'features/local-recording'];
    const localVideo = getLocalVideoTrack(state[
    ...
    if (enableFeaturesBasedOnToken) {
        ...
        // feature enabled
        desktopSharingEnabled = getParticipants(
                state)
            .find(({
                    features = {}
                }) =>
    ...
    const buttons = new Set(interfaceConfig
        .TOOLBAR_BUTTONS);
    ...
    return {
        ...
        _dialog: Boolean(state[
                'features/base/dialog']
            .component),
        _feedbackConfigured: Boolean(callStatsID),
        _isGuest: state['features/base/jwt']
            .isGuest,
        _fullScreen: fullScreen,
        _tileViewEnabled: shouldDisplayTileView(
            state),
        ...
        _screensharing: localVideo && localVideo
            .videoType === 'desktop',
        _sharingVideo: sharedVideoStatus ===
            'playing' ||
            sharedVideoStatus === 'start' ||
            sharedVideoStatus === 'pause',
        _visible: isToolboxVisible(state),
        _visibleButtons: equals(visibleButtons,
