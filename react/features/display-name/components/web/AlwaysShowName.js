...
/**
 * The type of the React {@code Component} props of {@link AlwaysShowName}.
 */
type Props = {
...
/**
 * The type of the React {@code Component} state of {@link AlwaysShowName}.
 */
type State = {
 ...
 * @extends Component
 */
class AlwaysShowName extends Component<Props, State> {
    ...
    /**
     * Initializes a new {@code AlwaysShowName} instance.
     *
    ...
    render() {
        ...
        return (
            <span
                className = 'displayname alwaysShowName'
                id = { elementID }
...
export default translate(connect(_mapStateToProps)(AlwaysShowName));
